...
from g_tools import get_sheet_settings, USDPYG
from lib import count_cron_runs
...
class Recurrent:
    ...
    def get_total_value(self) -> float:
        ...
        """
        runs = count_cron_runs(self.recurrence, self.start_date, self.maturity_date)
        currency_factor = 1.0
        if self.currency != "USD":
            currency_factor = USDPYG  # Assuming USDPYG is defined elsewhere
        return self.amount * runs / currency_factor
