...
class Instrument:
    ...
    def get_current_value(self):
        ...
        if self.currency == "PYG":
            return self.qty * self.price * self.factor / USDPYG
    ...
    def __repr__(self):
        return f"Asset(symbol={self.symbol}, value={self.get_current_value()}, currency={self.currency}, location={self.location})"
