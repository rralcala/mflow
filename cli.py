...
check_history_parser = subparsers.add_parser(
    "check-history", help="Check performance history"
)
check_history_parser.add_argument(
    "-d", "--debug", action="store_true", help="Debug logging."
)
check_history_parser.add_argument(
    "-p", "--plot", action="store_true", help="Create chart."
)
check_history_parser.set_defaults(func=handle_check_history)

create_transaction_parser = subparsers.add_parser(
    "create-transaction", help="Create transaction"
)
create_transaction_parser.add_argument(
    "-a", "--account", type=str, help="Create chart.", required=True
)
create_transaction_parser.add_argument(
    "-y", "--year", type=str, help="Create chart.", required=False
)
create_transaction_parser.add_argument(
    "-m", "--month", type=str, help="Create chart.", required=False
)
create_transaction_parser.add_argument(
    "-c", "--amount", type=str, help="Create chart.", required=True
)
create_transaction_parser.add_argument(
